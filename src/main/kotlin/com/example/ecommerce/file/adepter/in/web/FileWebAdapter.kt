package com.example.ecommerce.file.adepter.`in`.web

import com.example.ecommerce.file.adepter.`in`.web.response.FileStorageResponse
...
import com.example.ecommerce.file.application.port.`in`.UploadFileUseCase.Companion.invoke
